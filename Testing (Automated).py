'''The whole program is written in Python Language using the Selenium Library
The whole code is written by Madhav Chandok'''
...
sf=webdriver.Chrome(executable_path="C:\\Python39\Lib\\site-packages\\selenium\\webdriver\\chrome\\chromedriver.exe")
...
try:
    ...
    time.sleep(4)
    sf.find_element_by_name("Name").send_keys("Madhav Chandok")
    time.sleep(4)
    sf.find_element_by_name("Email").send_keys("madhavchandok.iimt@gmail.com")
    time.sleep(4)
